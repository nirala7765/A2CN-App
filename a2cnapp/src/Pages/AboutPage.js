            ...
            <div className="md:flex justify-between mt-6 w-[85%] mx-auto md:w-full md:mx-0">
              <div className="lg:w-[350px] md:w-[250px] bg-blue-gray-800 border-[1px] border-white justify-center items-center py-5 rounded-md shadow-md my-3">
                <img
                  ...
                  alt=""
                />
                <h1 className="mt-9 lg:text-[25px] font-bold">
                  Amar Kumar Chaudhari
                </h1>
            ...
            <div className="space-y-5 mt-8">
              <div className="flex flex-col md:flex-row w-full justify-between md:gap-3 gap-6">
                <div className="w-full md:w-1/2">
                  <div className="flex">
                    <img src={startup} alt="" />
                    <h1 className="md:text-[25px] font-bold md:mt-5 md:ml-7 text-[15px] mt-7">
                  ...
                  <div className="md:ml-[120px] md:mt-0 mt-5">
                    <p className="text-start text-[15px] font-semibold">
                      ...
                      startups, that’s why we take a unique approach that
                      combines traditional and new methods to develop quality
                      startup apps.
                    </p>
                  </div>
                </div>
                <div className="w-full md:w-1/2">
                  <div className="flex">
                    <img src={rescue} alt="" />
                    <h1 className="md:text-[25px] font-bold mt-5 ml-7 text-[15px]">
                      Rescue Projects
                    </h1>
                  </div>
                  <div className="md:ml-[120px] md:mt-0 mt-5">
